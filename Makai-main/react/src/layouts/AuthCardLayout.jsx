          ...
          <Card className="overflow-hidden z-index-1">
            <Card.Body className="p-0">
              <Row className="h-100 g-0">
                  ...
                  <div className="position-relative p-4 pt-md-5 pb-md-7">
                    ...
                    <div className="z-index-1 position-relative light">
                      ...
                      <p className="opacity-75 text-white">
                        We are a watersport rental solution that allows anyone
                        to conveniently rent paddleboards and surfboards at
                        designated stations.
                      </p>
                    </div>
                  </div>
                ...
                >
                  <div className="p-4 pt-md-5 flex-grow-1">{children}</div>
                </Col>
              </Row>
            </Card.Body>
          </Card>
