...
const _logger = debug.extend("ProductsForm.jsx");
...
const ProductsForm = () => {
  ...
  const handleSubmit = (values, { resetForm }) => {
    ...
    const payload = {
      ...
      hourlyPriceInCents: Math.round(values.hourlyPriceInCents),
  ...
  const onImageUpload = (setFieldValue, response) => {
    response.items && setFieldValue("imageId", response.items[0].id);
  };
                ...
                <div className="card-body bg-light pb-0">
                  <div className="mb-3">
                    ...
                    <ErrorMessage
                      ...
                      className="has-error"
                    />
                    <label className="form-label" htmlFor="imageId">
                      Upload An Image
                    </label>
                    <FileUploader
                      name="imageId"
                      onUploadSuccess={(response) =>
                        onImageUpload(setFieldValue, response)
                      }
                    />
                    <ErrorMessage
                      name="imageId"
