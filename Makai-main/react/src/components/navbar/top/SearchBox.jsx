...
import { FaSearch, FaCircle, FaChevronRight } from "react-icons/fa";
    ...
    <Dropdown onToggle={toggle} className="search-box">
      ...
      >
        <Form className="position-relative">
          ...
          />
          <FaSearch className="position-absolute text-400 search-box-icon" />
          {searchInputValue && (
            <div
          ...
          {isIterableArray(recentlyBrowsedItems) && (
            <>
              ...
              {recentlyBrowsedItems.map((item) => (
                ...
                >
                  <Flex alignItems="center">
                    <FaCircle className="me-2 text-300 fs--2" />
                        ...
                        return (
                          <Fragment key={breadCrumbText}>
                            ...
                            {item.breadCrumbTexts.length - 1 > index && (
                              <FaChevronRight className="mx-1 text-500 fs--2" />
                            )}
                          </Fragment>
                        );
                      })}
