        ...
        */
        ...
        public static TimeSpan GetSafeTimeSpan(this IDataReader reader, Int32 ordinal)
        {
            if (reader[ordinal] != null && reader[ordinal] != DBNull.Value)
            {
                ...
                return sqlDataReader.GetSafeTimeSpan(ordinal);
            }
            else
            {
                return default(TimeSpan);
        ...
        public static TimeSpan? GetSafeTimeSpanNullable(this IDataReader reader, Int32 ordinal)
        {
            if (reader[ordinal] != null && reader[ordinal] != DBNull.Value)
            {
                return reader.GetSafeTimeSpan(ordinal);
            }
            else
            {
                return null;
